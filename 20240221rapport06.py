# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 14:36:46 2024
...
r_th_A = 1e-3*(1.2 * e*1e-7) / (pi * 1e-4*1e-4)
r_th_B = 1e-3*(1.2 * e*1E-7) / (pi * 0.6e-4*0.6e-4)
r_th_C = 1e-3*(1.2 * e*1E-7) / (pi * 0.4e-4*0.4e-4)
r_th_D = 1e-3*(1.2 * e*1E-7) / (pi * 0.25e-4*0.25e-4)

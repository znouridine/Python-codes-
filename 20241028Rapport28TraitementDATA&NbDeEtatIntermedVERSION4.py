# -*- coding: utf-8 -*-
"""
Created on Wed November 13 16:37:32 2024
@author: nouri
"""
globals().clear()
import numpy as np
...
plt.title('Données brutes')
DF = pd.DataFrame(X0)
DF.to_csv(""+dos+"/D_RESET.csv")
plt.savefig(""+dos+"/D_RESET.svg")
# plt.legend(loc='upper right', fontsize="6")
...
plt.title('Données brutes')
DF = pd.DataFrame(X1)
DF.to_csv(""+dos+"/D_SET.csv")
plt.savefig(""+dos+"/D_SET.svg")
# plt.legend(loc='upper right', fontsize="6")

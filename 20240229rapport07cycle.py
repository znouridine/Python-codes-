# -*- coding: utf-8 -*-
"""
Created on Thu Feb 29 10:01:58 2024
...
data=np.loadtxt("20240301/" + name + ".NL",skiprows=3)
...
for i in range(t):
    #RESET conditions
    if a4[i]==6E-9 and a3[i]==20E-9 or a3[i]==10E-9 or a3[i]==30E-9  : #or a3[i]==12E-9 or a3[i]==14E-9 or a3[i]==16E-9 or a3[i]==18E-9 or a3[i]==20E-9 or a3[i]==22E-9 or a3[i]==24E-9 or a3[i]==25E-9:
        X0[i][1]=a1[i]

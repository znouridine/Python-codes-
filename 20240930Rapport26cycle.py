# -*- coding: utf-8 -*-
"""
Created on MON Sept 30 15:37:32 2024
...
Via = float(input('Taille du VIA en um: '))
Cr = float(input('% du Chrome: '))
data = np.loadtxt("20240930/" + name + ".NL", skiprows=3, usecols=range(0, 14))
c2 = data[:, 1];
c4 = data[:, 3];
c9 = data[:, 8];
c10 = data[:, 9]
